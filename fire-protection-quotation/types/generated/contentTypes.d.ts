...
export interface ApiQuotationItemQuotationItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::quotation-item.quotation-item'
    > &
      Schema.Attribute.Private;
...
export interface ApiQuotationQuotation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    quotation_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::quotation-item.quotation-item'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::quotation-item.quotation-item': ApiQuotationItemQuotationItem;
